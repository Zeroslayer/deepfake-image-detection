...
#   cd "E:\Study\report 3 dpl 302m"
#   python predict_deepfake.py --image "C:\Users\nhath\Pictures\phuc.jpg"
...
def load_model(model_path, device):
    if not os.path.exists(model_path):
        print("Khong tim thay file: " + model_path)
        sys.exit(1)
...
def main():
    ...
    parser.add_argument('--model', type=str,
                        default=os.path.join('E:\\', 'Study', 'report 3 dpl 302m', 'best_model.pth'),
                        help='Duong dan file best_model.pth')
